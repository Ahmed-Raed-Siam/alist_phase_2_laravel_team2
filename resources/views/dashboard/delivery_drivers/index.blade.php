                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered nowrap delivery-drivers-list-table display">
                                <thead>
                                <tr>
        ...
        <div class="modal-dialog mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal-title">{{__('أضافة سائق')}}</h5>
                    <!--begin::Close-->
...
@push('script')
        ...
        <script>
            var $url = "{{ route('delivery-drivers.index') }}";
            var $deleteAllurl = "{{ route('delivery-drivers-destroyAll') }}";
        ...
        <script>
            ...
            $(function() {
                ...
                $("#add_new").click(function(e) {
                    ...
                    if($(this).attr('id') == 'add_new'){
                        ...
                        $.ajax({
                            ...
                            url: "{{url('dashboard/delivery-drivers') }}",
                            type: "POST",
                            dataType: 'json',
                            success: function(data) {
                                ...
                                $('.delivery-drivers-list-table').DataTable().ajax.reload();
                                $("#add_new").html("{{ __('حفظ') }}");
                                setTimeout(function() {
                                    location.reload();
                                }, 2000)
                        ...
                        $.ajax({
                            data: $("#modal_add_new_form").serialize(),
                            url: "{{url('dashboard/delivery-drivers') }}" + '/' + record_id ,
                            type: "POST",
                            method: "PUT",
                            dataType: 'json',
                            success: function(data) {
                ...
                $('body').on('click', '.editRecord', function() {
                    ...
                    $.get("{{ url('dashboard/delivery-drivers') }}" + '/' + record_id + '/edit', function(data) {
                        $('#add_new').html("تعديل");
                        $('#modal-title').html('تعديل سائق');
