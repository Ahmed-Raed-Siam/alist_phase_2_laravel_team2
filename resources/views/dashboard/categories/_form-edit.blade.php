...
<div class="form-group mb-3">
            ...
            <input type="text" name="ar_name" value="{{ old ('ar_name',$category->ar_name) }}" class="form-control @error('ar_name') is-invlaid @enderror">
            @error('ar_name')
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="en_name" value="{{ old ('en_name',$category->en_name) }}" class="form-control @error('en_name') is-invlaid @enderror">
            @error('en_name')
            <p class="invalid-feedback d-block">{{ $message }}</p>
            @enderror
        </div>
